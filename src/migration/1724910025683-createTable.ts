...
export class CreateTable1724910025683 implements MigrationInterface {
    name = 'CreateTable1724910025683'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "question" ("questionId" SERIAL NOT NULL, "question_location" character varying NOT NULL, "question_no" integer NOT NULL, "question_text" character varying NOT NULL, "answer_location" character varying, "answer_text" character varying, "isAnswerTextAvailable" boolean NOT NULL DEFAULT false, "interviewId" character varying, CONSTRAINT "PK_f5c864430d1f3626bc6671d6b8d" PRIMARY KEY ("questionId"))`);
